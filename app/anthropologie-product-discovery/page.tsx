                        ...
                        <FadeIn delay={60}>
                            <div style={{
                                ...
                                {[
                                    ...
                                    { num: "03", title: "Make Selection", caption: "Apply filter options.", src: "/images/Sort%20Modal-1.png" },
                                    { num: "04", title: "Return & Review", caption: "Review applied selections.", src: "/images/Sort%20Modal%202.png" },
                                ].map((screen, i) => (
