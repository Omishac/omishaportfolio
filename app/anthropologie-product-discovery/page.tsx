                        ...
                        <FadeIn delay={60}>
                            <div style={{
                                ...
                                {[
                                    ...
                                    { num: "02", title: "Choose Filter", caption: "Enter a filter category to refine results.", src: "/images/Sort%20Modal-1.png" },
                                    { num: "03", title: "Make Selection", caption: "Apply options within a separate screen.", src: "/images/Sort%20Modal-2.png" },
                                    { num: "04", title: "Return & Review", caption: "Return to the drawer to review selections.", src: "/images/Sort%20Modal%202.png" },
                                ].map((screen, i) => (
